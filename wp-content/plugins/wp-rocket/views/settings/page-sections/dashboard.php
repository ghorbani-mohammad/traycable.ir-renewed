		...
		<div class="wpr-Page-col">
			...
			<div class="wpr-field wpr-field-account">
				<div class="wpr-flex wpr-flex--egal">
					...
					<span class="wpr-infoAccount <?php echo (Rocket_Tester::is_activated()) ? 'wpr-isValid' : 'wpr-isInvalid'; ?>" id="wpr-account-data"><?php echo Rocket_Tester::get_license_code(); ?></span><br>

					</div>
					<div>
						<a href="<?php echo admin_url( 'admin.php?page=zhk_guard_register_rocket' ); ?>" target="_blank" class="wpr-button wpr-button--icon wpr-button--small wpr-button--purple wpr-icon-user"><?php _e('View license status', 'rocket'); ?></a>
					</div>
				</div>
			</div>
			<?php endif; ?>
