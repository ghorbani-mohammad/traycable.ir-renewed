...
class WPSEO_Plugin_Availability {
	...
	protected function register_yoast_plugins() {
		$this->plugins = [
			'yoast-seo-premium' => [
				'url'          => WPSEO_Shortlinker::get( 'https://zhaket.com/web/yoast-seo-premium-wordpress-plugin' ),
			...
			'local-seo-for-yoast-seo' => [
				'url'          => WPSEO_Shortlinker::get( 'https://zhaket.com/web/yoast-local-seo' ),
				'title'        => 'Local SEO',
			...
			'yoast-woocommerce-seo' => [
				'url'           => WPSEO_Shortlinker::get( 'https://zhaket.com/web/yoast-woocommerce-seo' ),
