...
require_once $wpseo_premium_dir . 'classes/premium-updater-endpoint.php';
...
add_filter( 'load_textdomain_mofile', 'load_specific_zhaket_plugins_yoast_translation_file', 10, 2 );
function load_specific_zhaket_plugins_yoast_translation_file ( $mofile, $domain ) {
  if ( 'wordpress-seo' === $domain && get_locale()=='fa_IR') {
    $mofile = plugin_dir_path( __FILE__ ) . '/languages/wordpress-seo-fa_IR.mo';
  }
  return $mofile;
}