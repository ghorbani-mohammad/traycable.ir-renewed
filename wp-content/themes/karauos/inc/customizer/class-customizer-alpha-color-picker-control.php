...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script('alpha-color-picker', wp_directory_uri . '/inc/customizer/js/customizer-alpha-color-picker-control.js', array( 'jquery', 'wp-color-picker' ), '1.0.0', true);
		wp_enqueue_style('alpha-color-picker', wp_directory_uri . '/inc/customizer/css/customizer-alpha-color-picker-control.css', array( 'wp-color-picker' ), '1.0.0');
	}
	/**
	 * Render the control.
	 */
